...
public class PaymentMethodAccessDeniedException extends CustomException {

    public PaymentMethodAccessDeniedException() {
        super(ErrorMessage.PAYMENT_METHOD_ACCESS_DENIED.getMessage(), HttpStatus.FORBIDDEN);
    }
}
